...
class SaeTClientV2
{
	 ...
	 * @return array
	 */
	function home_timeline( $page = 1, $count = 200, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0 )
	{
		$params = array();
		if ($since_id) {
	 ...
	 * @return array
	 */
	function user_timeline_by_id( $uid = NULL , $page = 1 , $count = 10 , $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0)
	{
		$params = array();
		$params['uid']=$uid;
		if ($since_id) {
  ...
  function show_batch( $ids )
	 ...
	 * @return array
	 */
	function friends_by_id( $uid, $cursor = 0, $count = 200 )
	{
		$params = array();
